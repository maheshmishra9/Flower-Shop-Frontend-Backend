# Generated by Django 4.0.2 on 2022-02-23 04:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('On the way', 'On the way'), ('Order Processing', 'Order Processing'), ('Order Canceled', 'Order Canceled'), ('Order Completed', 'Order Completed'), ('Order Received', 'Order Received')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
